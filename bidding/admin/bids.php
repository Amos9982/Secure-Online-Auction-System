				...
				<div class="card">
					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							<thead>
								<tr>
								<!-- Shows table row names -->	
                                                                    <th class="text-center">#</th>
									<th class="">Item Name</th>
									<th class="">User</th>
									<th class="">Bid Amount</th>
									<th class="">Bidding Status</th>
									<th class=""></th>
								</tr>
							</thead>
							<tbody>
							<!-- Shows information of buyer and their bidding items-->	
                                                            <?php 
								$i = 1;
								$cat = array();
								$cat[] = '';
								...
								<tr>
									...
									<td class="text-center">
										...
										<?php else: ?>
										<span class="badge badge-secondary">Lost in Bidding</span>
										<?php endif; ?>
										<?php endif; ?>
...
<script>
        //Shows the list of bids table
	$(document).ready(function(){
		$('table').dataTable()
	})
	//Shows buyer details such as name, email, contact and address
	$('.view_user').click(function(){
		uni_modal("<i class'fa fa-card-id'></i> Buyer Details","view_udet.php?id="+$(this).attr('data-id'))
		
	})
        //Book function under development...
